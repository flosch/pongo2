...
func filterTruncatechars(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	s := in.String()
	newLen := param.Integer()
	return AsValue(filterTruncatecharsHelper(s, newLen)), nil
}

func filterTruncatecharsHTML(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	value := in.String()
...
func filterTruncatewords(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
...
func filterTruncatewordsHTML(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	value := in.String()
...
func filterEscape(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
...
func filterSafe(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	return in, nil // nothing to do here, just to keep track of the safe application
}

func filterEscapejs(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	sin := in.String()
...
func filterAdd(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
...
func filterAddslashes(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	output := strings.Replace(in.String(), "\\", "\\\\", -1)
	output = strings.Replace(output, "\"", "\\\"", -1)
	output = strings.Replace(output, "'", "\\'", -1)
	return AsValue(output), nil
...
func filterCut(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	return AsValue(strings.Replace(in.String(), param.String(), "", -1)), nil
}

func filterLength(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	return AsValue(in.Len()), nil
}

func filterLengthis(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	return AsValue(in.Len() == param.Integer()), nil
}

func filterDefault(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	if !in.IsTrue() {
		return param, nil
	}
	return in, nil
...
func filterDefaultIfNone(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	if in.IsNil() {
		return param, nil
	}
	return in, nil
...
func filterDivisibleby(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	if param.Integer() == 0 {
...
func filterFirst(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
...
func filterFloatformat(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	val := in.Float()
...
func filterGetdigit(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	i := param.Integer()
...
func filterIriencode(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	var b bytes.Buffer
...
func filterJoin(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	if !in.CanSlice() {
		return in, nil
	}
	sep := param.String()
...
func filterLast(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	if in.CanSlice() && in.Len() > 0 {
...
func filterUpper(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	return AsValue(strings.ToUpper(in.String())), nil
}

func filterLower(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	return AsValue(strings.ToLower(in.String())), nil
}

func filterMakelist(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	s := in.String()
...
func filterCapfirst(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	if in.Len() <= 0 {
		return AsValue(""), nil
	}
	t := in.String()
...
func filterCenter(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	width := param.Integer()
	slen := in.Len()
	if width <= slen {
		return in, nil
...
func filterDate(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
...
func filterFloat(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	return AsValue(in.Float()), nil
}

func filterInteger(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	return AsValue(in.Integer()), nil
}

func filterLinebreaks(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	if in.Len() == 0 {
		return in, nil
	}
...
func filterLinebreaksbr(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	return AsValue(strings.Replace(in.String(), "\n", "<br />", -1)), nil
}

func filterLinenumbers(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	lines := strings.Split(in.String(), "\n")
...
func filterLjust(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
...
func filterUrlencode(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
...
func filterUrlizeHelper(ctx *ExecutionContext, input string, autoescape bool, trunc int) string {
	sout := filterUrlizeURLRegexp.ReplaceAllStringFunc(input, func(raw_url string) string {
		...
		t, err := ApplyFilter(ctx, "iriencode", AsValue(raw_url), nil)
		if err != nil {
			panic(err)
		}
		url := t.String()
		...
		if autoescape {
			t, err := ApplyFilter(ctx, "escape", AsValue(title), nil)
			if err != nil {
				panic(err)
			}
			title = t.String()
...
func filterUrlize(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	autoescape := true
	if param.IsBool() {
		autoescape = param.Bool()
	}

	return AsValue(filterUrlizeHelper(ctx, in.String(), autoescape, -1)), nil
}

func filterUrlizetrunc(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	return AsValue(filterUrlizeHelper(ctx, in.String(), true, param.Integer())), nil
}

func filterStringformat(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	return AsValue(fmt.Sprintf(param.String(), in.Interface())), nil
}

var reStriptags = regexp.MustCompile("<[^>]*?>")

func filterStriptags(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	s := in.String()
...
func filterPhone2numeric(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	sin := in.String()
...
func filterPluralize(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	if in.IsNumber() {
...
func filterRandom(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	if !in.CanSlice() || in.Len() <= 0 {
		return in, nil
	}
	i := rand.Intn(in.Len())
...
func filterRemovetags(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	s := in.String()
...
func filterRjust(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	return AsValue(fmt.Sprintf(fmt.Sprintf("%%%ds", param.Integer()), in.String())), nil
}

func filterSlice(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
...
func filterTitle(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	if !in.IsString() {
		return AsValue(""), nil
	}
...
func filterWordcount(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	return AsValue(len(strings.Fields(in.String()))), nil
}

func filterWordwrap(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
	words := strings.Fields(in.String())
	wordsLen := len(words)
...
func filterYesno(ctx *ExecutionContext, in *Value, param *Value) (*Value, *Error) {
